...
class Generator(nn.Module):
    def __init__(self):
        ...
        self.deconv3 = nn.ConvTranspose2d(32, 3, 5)
        self.deconv3_bn = nn.BatchNorm2d(3)
...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(3, 32, 5) # 24
        self.conv1_bn = nn.BatchNorm2d(32)
        self.conv2 = nn.Conv2d(32, 64, 5) # 20
        self.conv2_bn = nn.BatchNorm2d(64)
        self.conv3 = nn.Conv2d(64, 96, 5) # 16
